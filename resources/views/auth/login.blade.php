            ...
            <div class="col-12 d-flex align-items-center justify-content-center">
                ...
                <div class="col-xl-3 col-lg-4 col-md-5 col-sm-5 col-12 p-0 text-center d-none d-md-block">
                    <div class="border-grey border-lighten-3 m-0 box-shadow-0 card-account-left height-400"
                        ...
                        <img src="{{ asset('images/logo.png') }}" class="card-account-img width-300"
                        ...
                        <div class="card-content">
                            <div class="card-body p-3">
                                <p class="text-center h5 text-capitalize">
                                    {{ __('Bienvenido a ' . config('app.name', 'MINAGUAS') . '!') }}</p>
                                <p class="mb-1 text-center">
                                    {{ __('Por favor ingresa tu correo y contraseña para ingresar al sistema') }}</p>
                                <form class="form-horizontal form-signin" action="{{ route('login') }}" method="POST">
                                    ...
                                    <button type="submit"
                                        class="btn-gradient-primary btn-block my-1">{{ __('Ingresar') }}</button>
                                </form>
                            </div>
                        </div>
                    </div>
