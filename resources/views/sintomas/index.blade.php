        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <table style="width: 100% !important" id="sintomasTable"
                        ...
                        <tbody>
                            @foreach($pacientes as $persona)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary mx-1" href="{{ route('detallesSintomas', ['cedula' => $persona->cedula]) }}">
                                            Ver
                                        </a>
                                    </td>
                                </tr>
